...
const steps = [
  {
    id: 1,
    title: 'Tell Nora what\'s wrong',
    description: 'Describe your symptoms or health needs in natural language',
    icon: (
  ...
  },
  {
    ...
    description: 'Our AI finds the perfect providers who accept your insurance',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 3,
    title: 'Book or chat with your doctor',
    description: 'Schedule instantly or message before your visit',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
